...
extern "C" unsigned int d_makeTextureFrom(const char *name, const unsigned char *buf, size_t len, unsigned int *w, unsigned int *h) {
	pnginfo png = readpng__001(name, buf, len);
	if (png.d == 0)
		return 0;
